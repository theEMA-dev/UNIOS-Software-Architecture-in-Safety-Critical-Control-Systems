...
## Generated on : Sat Jun 07 22:56:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\BlindSpotLogicSWC.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\BlindSpotLogicSWC.exe
...
SRCS = $(START_DIR)\BlindSpotLogicSWC_autosar_rtw\BlindSpotLogicSWC.c
...
{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\stub}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\stub}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\stub}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\stub}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
BlindSpotLogicSWC.obj : "$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\BlindSpotLogicSWC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\BlindSpotLogicSWC_autosar_rtw\BlindSpotLogicSWC.c"
