###########################################################################
## Makefile generated for component 'WarningDisplaySWC'. 
## 
## Makefile     : WarningDisplaySWC.mk
## Generated on : Sun Jun 08 00:05:52 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\WarningDisplaySWC.exe
...
PRODUCT_NAME              = WarningDisplaySWC
MAKEFILE                  = WarningDisplaySWC.mk
...
COMPILER_COMMAND_FILE     = WarningDisplaySWC_comp.rsp
CMD_FILE                  = WarningDisplaySWC.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\WarningDisplaySWC.exe
...
DEFINES_STANDARD = -DMODEL=WarningDisplaySWC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\WarningDisplaySWC_autosar_rtw\WarningDisplaySWC.c
...
{$(START_DIR)\WarningDisplaySWC_autosar_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw\stub}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw\stub}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw\stub}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WarningDisplaySWC_autosar_rtw\stub}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
WarningDisplaySWC.obj : "$(START_DIR)\WarningDisplaySWC_autosar_rtw\WarningDisplaySWC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\WarningDisplaySWC_autosar_rtw\WarningDisplaySWC.c"
