...
extern void RadarSensorSWC(const BlindSpotDetectedType *rtu_Simulation_BSD_Left,
  const BlindSpotDetectedType *rtu_Simulation_BSD_Right, BlindSpotDetectedType
  *rty_LeftBlindSpotDetected, BlindSpotDetectedType *rty_RightBlindSpotDetected);
