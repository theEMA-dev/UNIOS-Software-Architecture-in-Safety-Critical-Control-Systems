...
## Generated on : Sun Jun 08 02:11:42 2025
## Final product: .\RadarSensorSWC_rtwlib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = RadarSensorSWC_rtwlib.lib
...
PRODUCT = .\RadarSensorSWC_rtwlib.lib
...
SRCS = $(START_DIR)\slprj\autosar\RadarSensorSWC\RadarSensorSWC.c
...
{$(START_DIR)\slprj\autosar\RadarSensorSWC}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\RadarSensorSWC}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\RadarSensorSWC}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\RadarSensorSWC}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
RadarSensorSWC.obj : "$(START_DIR)\slprj\autosar\RadarSensorSWC\RadarSensorSWC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\autosar\RadarSensorSWC\RadarSensorSWC.c"
