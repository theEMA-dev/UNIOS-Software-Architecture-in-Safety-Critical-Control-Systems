...
## Generated on : Sun Jun 08 02:11:47 2025
## Final product: .\VehicleStatusSWC_rtwlib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = VehicleStatusSWC_rtwlib.lib
...
PRODUCT = .\VehicleStatusSWC_rtwlib.lib
...
SRCS = $(START_DIR)\slprj\autosar\VehicleStatusSWC\VehicleStatusSWC.c
...
{$(START_DIR)\slprj\autosar\VehicleStatusSWC}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\VehicleStatusSWC}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\VehicleStatusSWC}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\VehicleStatusSWC}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
VehicleStatusSWC.obj : "$(START_DIR)\slprj\autosar\VehicleStatusSWC\VehicleStatusSWC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\autosar\VehicleStatusSWC\VehicleStatusSWC.c"
