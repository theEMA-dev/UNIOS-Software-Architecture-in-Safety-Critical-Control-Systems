...
## Generated on : Mon Jun 09 16:17:19 2025
## Final product: .\WarningDisplaySWC_rtwlib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = WarningDisplaySWC_rtwlib.lib
...
PRODUCT = .\WarningDisplaySWC_rtwlib.lib
...
SRCS = $(START_DIR)\slprj\autosar\WarningDisplaySWC\WarningDisplaySWC.c
...
{$(START_DIR)\slprj\autosar\WarningDisplaySWC}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\WarningDisplaySWC}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\WarningDisplaySWC}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\autosar\WarningDisplaySWC}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
WarningDisplaySWC.obj : "$(START_DIR)\slprj\autosar\WarningDisplaySWC\WarningDisplaySWC.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\slprj\autosar\WarningDisplaySWC\WarningDisplaySWC.c"
